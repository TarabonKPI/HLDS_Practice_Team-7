...
function App() {
  ...
  async function handleCreateNewSaveClick() {
    if( !values.entity ) {
      alert( 'Please, enter a teamcode in format: team7' )
      return
    }
  ...
  return (
    <div className="App">
      <div className="container">
        <h2>HLDS Teams Control Panel</h2>
        <form>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">Please, enter a teamcode in a format: team7</label>
          ...
          <button type="button" onClick={ handleCreateNewClick } className="btn btn-secondary">Add New Team Member</button>
        </form>
